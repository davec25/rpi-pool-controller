...
{
    caps_relativeHumidityMeasurement_data_t *caps_data = 
			(caps_relativeHumidityMeasurement_data_t*)usr_data;
...
caps_relativeHumidityMeasurement_data_t *caps_relativeHumidityMeasurement_initialize(IOT_CTX *ctx, const char *component, void *init_usr_cb, void *usr_data)
{
    ...
    caps_data = (caps_relativeHumidityMeasurement_data_t*)malloc(sizeof(caps_relativeHumidityMeasurement_data_t));
    if (!caps_data) {
    ...
    caps_data->init_usr_cb = (void (*)(caps_relativeHumidityMeasurement_data_t*))init_usr_cb;
    caps_data->usr_data = (caps_relativeHumidityMeasurement_data_t*)usr_data;
